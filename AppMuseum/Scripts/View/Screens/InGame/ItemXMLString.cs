...
{
    public class ItemXMLString : MonoBehaviour, ISlotView
    {
        public const string EventItemXMLStringSelected = "EventItemXMLStringSelected";
        ...
        public void Initialize(params object[] parameters)
        {
            ...
            _text = (string)((ItemMultiObjectEntry)parameters[0]).Objects[2];

            transform.Find("Name").GetComponent<TextMeshProUGUI>().text = _text;
        ...
        {
            Selected = !Selected;
			UIEventController.Instance.DispatchUIEvent(EventItemXMLStringSelected, _parent, this.gameObject, (Selected ? _index : -1), _text);
        }

		private void OnUIEvent(string nameEvent, object[] parameters)
		{
            if (nameEvent.Equals(EventItemXMLStringSelected))
            {
