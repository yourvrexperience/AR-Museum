...
{
    public class ItemPOIMuseum : MonoBehaviour, ISlotView
    {        
        public const string EventItemPOIMuseumSelected = "EventItemPOIMuseumSelected";
        public const string EventItemPOIMuseumReset = "EventItemPOIMuseumReset";
        ...
        private object _objectBaseView;
        ...
        public void Initialize(params object[] parameters)
        {
            ...
            _objectBaseView = _data.Objects[1];
        ...
        {
            Selected = !Selected;
			UIEventController.Instance.DispatchUIEvent(EventItemPOIMuseumSelected, _parent, this.gameObject, (Selected ? _index : -1), _objectBaseView);
        }

		private void OnUIEvent(string nameEvent, object[] parameters)
		{
            if (nameEvent.Equals(EventItemPOIMuseumSelected))
            {
            ...
            if (nameEvent.Equals(EventItemPOIMuseumReset))
            {
                Selected = false;
            }
		}
