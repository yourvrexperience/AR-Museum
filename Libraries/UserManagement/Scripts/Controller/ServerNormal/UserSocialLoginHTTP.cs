...
#endif
	public class UserSocialLoginHTTP : BaseDataHTTP, IHTTPComms
	{
        ...
        public string UrlRequest
        {
            get
            {
                ...
                {
                    m_urlRequest = CommsHTTPConstants.Instance.GetBaseURL() + "UserSocialLogin.php";
                }
                return m_urlRequest;
            }
        }
		...
		public override void Response(string _response)
		{
			...
			{
				SystemEventController.Instance.DispatchSystemEvent(UsersController.EVENT_USER_LOGIN_RESULT, true, data);
			}
			else
			{
				SystemEventController.Instance.DispatchSystemEvent(UsersController.EVENT_USER_LOGIN_RESULT, false);
