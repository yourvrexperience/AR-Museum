...
{
	public class ChatGPTQuestionHistory
	{
...
#endif
	public class AskChatLocalHistoryGPTHTTP : BaseDataHTTP, IHTTPComms
	{
		public const string EventGenericAskChatHistoryGPTHTTPQuestionText = "EventGenericAskChatHistoryGPTHTTPQuestionText";
        ...
        public string Build(params object[] _list)
		{
			...
			_rawData = System.Text.Encoding.UTF8.GetBytes(
					JsonConvert.SerializeObject(new ChatGPTQuestionHistory
					{
        ...
        public override void Response(string _response)
		{
			...
			{
				SystemEventController.Instance.DispatchSystemEvent(EventGenericAskChatHistoryGPTHTTPCompleted, true, _response);
			}
		}
	}
