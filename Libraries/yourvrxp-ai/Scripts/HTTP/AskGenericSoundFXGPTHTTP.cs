...
#endif
	public class AskGenericSoundFXGPTHTTP : BaseDataHTTP, IHTTPComms
	{
		public const string EventGenericAskSoundFXGPTHTTPCompleted = "EventGenericAskSoundFXGPTHTTPCompleted";
		...
		{			            
			get { return GameAIData.Instance.ServerChatGPT + "audio?debug=true"; }
        }
		...
		public override void Response(string _response)
		{
			...
			if (!ResponseCode(_response))
			{
				...
				{
					SystemEventController.Instance.DispatchSystemEvent(EventGenericAskSoundFXGPTHTTPCompleted, false);
				}
			}
		}
		...
		public override void Response(byte[] _response)
		{
			...
			{
				SystemEventController.Instance.DispatchSystemEvent(EventGenericAskSoundFXGPTHTTPCompleted, true, _response);
			}
		}
	}
}