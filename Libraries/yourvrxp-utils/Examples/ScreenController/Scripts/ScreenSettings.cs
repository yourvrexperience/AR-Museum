...
{
	public class ScreenSettings : BaseScreenView, IScreenView
	{
		public const string ScreenName = "ScreenSettings";
		...
		public override void Initialize(params object[] parameters)
		{
			...
			titleScreen.text = LanguageController.Instance.GetText("screen.main.menu.settings");
