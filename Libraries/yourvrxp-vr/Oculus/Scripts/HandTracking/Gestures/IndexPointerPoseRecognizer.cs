...
{
	public class IndexPointerPoseRecognizer : MonoBehaviour
	{
		public const string EventIndexPointerPoseRecognizerTriggered = "EventIndexPointerPoseRecognizerTriggered";
		public const string EventIndexPointerPoseRecognizerReleased = "EventIndexPointerPoseRecognizerReleased";
#if ENABLE_OCULUS		
		...
		private void OnDetectedGesture()
		{
			...
			{
				VRInputController.Instance.DispatchVREvent(EventIndexPointerPoseRecognizerTriggered,  _isRightHand? XR_HAND.right: XR_HAND.left);
			}
		}
		...
		private void OnUnDetectedGesture()
		{
			if (_handTrackingState)
			{
				VRInputController.Instance.DispatchVREvent(EventIndexPointerPoseRecognizerReleased, _isRightHand? XR_HAND.right: XR_HAND.left);
			}
		}
